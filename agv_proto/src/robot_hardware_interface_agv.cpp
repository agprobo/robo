   ...
   const hardware_interface::HardwareInfo & info)
{
  ...
  RCLCPP_INFO(rclcpp::get_logger("DiffBotSystemHardware"), "Initializing hardware interface...");
  base_x_ = 0.0;
  base_y_ = 0.0;
  base_theta_ = 0.0;
  ...
  {
    CLCPP_INFO(rclcpp::get_logger("DiffBotSystemHardware"), "Configuring joint: %s", joint.name.c_str());
...
{
  RCLCPP_INFO(rclcpp::get_logger("DiffBotSystemHardware"), "Exporting state interfaces...");
  std::vector<hardware_interface::StateInterface> state_interfaces;
  for (auto i = 0u; i < info_.joints.size(); i++)
  { RCLCPP_INFO(rclcpp::get_logger("DiffBotSystemHardware"),
                "Adding position and velocity state interfaces for joint '%s'", info_.joints[i].name.c_str());
...
{ RCLCPP_INFO(rclcpp::get_logger("DiffBotSystemHardware"), "Exporting command interfaces...");

  std::vector<hardware_interface::CommandInterface> command_interfaces;
  for (auto i = 0u; i < info_.joints.size(); i++)
  { 
    RCLCPP_INFO(rclcpp::get_logger("DiffBotSystemHardware"),
                "Adding velocity command interface for joint '%s'", info_.joints[i].name.c_str());
...
hardware_interface::return_type agv_proto_hardware::DiffBotSystemHardware::write(const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
{
